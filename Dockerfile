...
RUN cd /opt && wget https://download.support.siren.solutions/kibi/community?file=kibi-community-standalone-4.6.3-linux-x64.zip&userId=17001229734 -O kibi-4.6.3-linux-x64.zip \
